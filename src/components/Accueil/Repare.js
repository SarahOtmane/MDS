        ...
        <main className="repare">
            ...
            <section className='row backGris'>
                <article className='row alignitem_center'>
                    ...
                    <p>1. Trouvez votre artisan & faites un devis pour obtenir une estimation de vos réparations</p>
                </article>
                <article className='row alignitem_center'>
                    ...
                    <p>2. Préparez vos vêtements/accessoires avant le dépôt</p>
                </article>
                <article className='row alignitem_center'>
                    ...
                    <p>3. Déposez le gratuitement sous 21 jours</p>
                </article>
                <article className='row alignitem_center'>
